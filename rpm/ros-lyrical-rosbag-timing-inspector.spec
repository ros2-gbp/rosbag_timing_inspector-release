...
%global pkg_name rosbag_timing_inspector
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-rosbag-timing-inspector
Version:        1.0.2
Release:        1%{?dist}
...
%changelog
* Sun Jun 21 2026 Jose Luis Blanco-Claraco <joseluisblancoc@gmail.com> - 1.0.2-1
- Autogenerated by Bloom

* Sun Jun 21 2026 Jose Luis Blanco-Claraco <joseluisblancoc@gmail.com> - 1.0.1-1
- Autogenerated by Bloom
